...
<DAT name="U_NAME">STARTDIALER</DAT>
<DAT name="UDESCR" xml:space='preserve'>Command to start tel dial</DAT>
<DAT name="U_DTYP">S</DAT>
<DAT name="U_DOC" xml:space='preserve'>Command to start telephone dialer, read in sysmenu</DAT>
</OCC>
</TABLE>
</UNIFACE>
