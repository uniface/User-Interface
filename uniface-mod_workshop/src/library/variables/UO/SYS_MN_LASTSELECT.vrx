...
<DAT name="U_NAME">SYS_MN_LASTSELECT</DAT>
<DAT name="UDESCR" xml:space='preserve'>Last selected prog</DAT>
<DAT name="U_DTYP">S</DAT>
<DAT name="U_DOC" xml:space='preserve'>Will open the tree at same node</DAT>
</OCC>
</TABLE>
</UNIFACE>
