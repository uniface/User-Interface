...
<DAT name="U_FORMLIB">UO</DAT>
<DAT name="U_NAME">SYS_VALIDATEFORM</DAT>
<DAT name="UDESCR" xml:space='preserve'>Validation form</DAT>
<DAT name="U_DTYP">S</DAT>
<DAT name="U_DOC" xml:space='preserve'>This indicates that the Validate entry form itself is running. (Execute trigger has been fired)</DAT>
</OCC>
</TABLE>
</UNIFACE>
