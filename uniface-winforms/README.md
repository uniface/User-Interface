...
SigWiz is an example of calling the windows API via Uniface signatures to enhance traditional Uniface forms user Interface and to explore accessing field widget properties non supported by the Uniface proc language.
## Dependencies ##

WinForms has been written and tested with:
...
### Setup WinForms as a standalone project ###
 ...
 * Clone the WinForms repository onto your local machine. For these steps we'll assume it's been cloned into C:\Projects\WinForms
